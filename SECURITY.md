...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/jtv-halting-islands-ct/security/advisories/new)
...
- This repository (`hyperpolymath/jtv-halting-islands-ct`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/jtv-halting-islands-ct/security/advisories)
...
When using Jtv Halting Islands Ct, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/jtv-halting-islands-ct/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/jtv-halting-islands-ct/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/jtv-halting-islands-ct/discussions) |
...
*Thank you for helping keep Jtv Halting Islands Ct and its users safe.* 🛡️
