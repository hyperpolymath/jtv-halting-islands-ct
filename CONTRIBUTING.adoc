...
git clone https://github.com/hyperpolymath/jtv-halting-islands-ct.git cd
...
toolbox create jtv-halting-islands-ct-dev toolbox enter
jtv-halting-islands-ct-dev # Install dependencies manually
...
jtv-halting-islands-ct/ ├── src/ # Source code (Perimeter 1-2) ├── lib/
